...
export default function Sobre() {
  ...
  return (
    <section id="sobre" className="w-full min-h-screen flex flex-col items-center justify-center bg-gray-100 text-center py-12">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-6 mt-8 w-11/12 max-w-[1200px]" data-aos="zoom-in">
        <div className="bg-white p-6 rounded-lg shadow-lg w-[280px] h-[380px]">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg w-[280px] h-[380px]" data-aos="zoom-in">
